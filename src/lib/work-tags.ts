...
export const WORK_TAG_GROUPS: WorkTagGroup[] = [
  {
    ...
    characters: [
      { tag: '龍華妃咲', keywords: ['龍華妃咲', '龙华妃咲', '妃咲', 'kisaki'] },
      { tag: '四季夏目', keywords: ['四季夏目', 'natsume'] },
      { tag: '桐生桔梗', keywords: ['桐生桔梗', '桐生キキョウ', 'キキョウ'] },
      { tag: '柚鳥夏', keywords: ['柚鳥夏', '柚鸟夏', '柚鳥ナツ', '柚鸟ナツ'] },
      { tag: '小鳥遊星野', keywords: ['小鳥遊星野', '小鸟游星野', '星野', 'hoshino', 'takanashihoshino'] },
      { tag: '聖園ミカ', keywords: ['聖園ミカ', 'misonomika'] },
      { tag: '早瀬優香', keywords: ['早瀬優香', '優香', '优香', '体操服优香'] },
      { tag: '靜山マシロ', keywords: ['静山マシロ', '靜山マシロ', 'mashiro'] },
      { tag: '陸八魔アル', keywords: ['陸八魔アル', 'アル', '아루'] },
    ],
  },
  {
    work: '明日方舟',
    ...
    characters: [
      { tag: '阿爾圖羅', keywords: ['阿爾圖羅', '阿尔图罗', '塑心', 'virtuosa'] },
      { tag: '普瑞賽斯', keywords: ['普瑞賽斯', '普瑞赛斯', 'priestess'] },
      { tag: '艾雅法拉', keywords: ['艾雅法拉', 'eyjafjalla'] },
      { tag: '能天使', keywords: ['能天使', 'exusiai'] },
      { tag: '德克薩斯', keywords: ['德克薩斯', '德克萨斯', 'texas'] },
  ...
  },
  {
    ...
    characters: [
      ...
      { tag: '花火', keywords: ['花火', 'sparkle'] },
      { tag: 'Hyacine', keywords: ['hyacine', 'ヒアンシー'] },
      { tag: 'Cyrene', keywords: ['cyrene', 'キュレネ'] },
      { tag: '長夜月', keywords: ['長夜月', '长夜月', 'evernight'] },
    ],
  },
  {
    work: '鳴潮',
  ...
  },
  {
    ...
    characters: [
      { tag: '儀玄', keywords: ['儀玄', '仪玄', 'yixuan'] },
      { tag: '千夏', keywords: ['千夏', 'chinatsu'] },
    ],
  },
  {
    work: '原神',
    ...
    characters: [
      { tag: '甘雨', keywords: ['甘雨', 'ganyu'] },
      { tag: '茜特菈莉', keywords: ['茜特菈莉', '茜特菈莉', 'citlali', 'シトラリ'] },
      { tag: '安柏', keywords: ['安柏', 'amber'] },
      { tag: '克洛琳德', keywords: ['克洛琳德', 'clorinde', 'クロリンデ'] },
      { tag: '納西妲', keywords: ['納西妲', '纳西妲', 'nahida'] },
    ],
  },
  {
    work: 'MyGO',
    ...
    characters: [
      { tag: '豐川祥子', keywords: ['豐川祥子', '丰川祥子', '祥子'] },
      { tag: '若葉睦', keywords: ['若葉睦', '若叶睦', '睦ちゃん'] },
    ],
  },
  {
    work: '碧藍航線',
    ...
    characters: [
      { tag: '綾波', keywords: ['綾波', '绫波', 'ayanami'] },
      { tag: '埃塞克斯', keywords: ['埃塞克斯', 'essex'] },
    ],
  },
  {
    work: '東方Project',
    ...
    characters: [
      { tag: '十六夜咲夜', keywords: ['十六夜咲夜', '咲夜', 'sakuya'] },
      { tag: '博麗靈夢', keywords: ['博麗靈夢', '博丽灵梦', '靈夢', '灵梦', 'reimu'] },
      { tag: '古明地戀', keywords: ['古明地戀', '古明地恋', 'こいし', 'koishi'] },
    ],
  },
  {
    work: 'Fate',
